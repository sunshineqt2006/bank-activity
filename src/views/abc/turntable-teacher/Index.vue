<template>
  <page noBack class="teacher">
    <unpaid slot="unpaid"></unpaid>
    <div class="body">
      <turntable :intervalColors="['#ccebea', '#ffffff']" :outsideRadius="180" :prizeList="prizeList"></turntable>
...
<style lang="less" scoped>
  .body {flex:1;overflow: auto;
    ...
    .rule{padding:20px 10px;margin: 20px 20px;line-height: 22px;
      .title{border-top-right-radius: 6px;border-bottom-right-radius: 6px;background: #ffffff;position: relative;left: -10px;display: inline-block;padding: 5px 10px;margin-bottom: 20px; }
    }
  }
</style>
