<template>
  <page>
    <div class="login">
      ...
      <img src="~assets/images/abc/logo.png" class="logo">
      <div class="form">
...
@import "~styles/var.less";
  .login {flex: 1;background: #ffffff;text-align: center;display: flex;flex-direction: column;justify-content: center;align-items: center;
    .logo { width: 160px;height:87px; }
    .form { margin: 40px 20px;
      .btn-login {background: #ffa900; margin-top: 30px;}
      .btn-yzm { background: #ffa900; width: 90px;}
    }
  }
