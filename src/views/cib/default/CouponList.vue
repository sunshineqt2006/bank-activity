    ...
    .body {flex: 1; display: flex;justify-content: center;
        .box {
            ...
            * {
            ...
            .film-bottom {
                ...
                .btn-detail {
                    ...
                    &.visited::after {
                        ...
                        border-left: 6px solid transparent;
                        border-right: 6px solid transparent;
                        border-bottom: 6px solid #05b5f1;
                    }
                }
            }
            .film-top {
            ...
            &.first .film-top {
                background: url("~assets/images/coupon_box_top_bg.png")
                    no-repeat;
                background-size: 100%;
                .type,
                .btn {
